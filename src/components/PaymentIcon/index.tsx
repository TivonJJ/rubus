...
const ICON_POS_ARRAY = [
    ['CashPay','Alipay','WechatPay','UnionPay_QR','UnionPay','Visa','Mastercard','JCB','DinersClub','AmericanExpress','MembershipCard','GroupBuying','GiftCard','CashCoupon','Free','TakeAway','Other','ICBCEPay']
];
