...
import { resetAccountPassword, updateAccount, delAccount } from '@/services/systemAccounts';
...
export const ChangeStatus:React.FC<OperateProps> = (props)=>{
    ...
    return (
        <Popconfirm
            title={`确定${toStatusText}“${data.real_name}”？`}
            onConfirm={change}
        >
