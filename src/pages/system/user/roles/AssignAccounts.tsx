...
import { getRoleAccounts, setRoleAccounts } from '@/services/systemAccounts';
...
const AssignAccounts: React.FC<AssignAccountsProps> = (props) => {
    ...
    const {run:setAccounts,loading:settingAccounts} = useRequest(setRoleAccounts,{ manual: true, throwOnError: true })
